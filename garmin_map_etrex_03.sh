...
if [ -f gmapsupp.img ]; then
  ...
  # ---------------------------------------------------------------------------
  pandoc -s -f markdown -t html --metadata-file /home/${local_filesystem_user}/src/SomeoneElse-map/metadata.yaml --metadata title="Maps for Garmin devices" -H /home/${local_filesystem_user}/src/SomeoneElse-map/mkgmap_header.html /home/${local_filesystem_user}/src/SomeoneElse-map/mkgmap.md > /var/www/html/maps/map/mkgmap.html
  pandoc -s -f markdown -t html --metadata-file /home/${local_filesystem_user}/src/SomeoneElse-map/metadata.yaml --metadata title="Changelog for mkgmap maps" -H /home/${local_filesystem_user}/src/SomeoneElse-map/mkgmap_header.html /home/${local_filesystem_user}/src/mkgmap_style_ajt/changelog_mkgmap.md > /var/www/html/maps/map/changelog_mkgmap.html
else
